// //arrays
// var randomBands = ['radiohead', 'blink-182', 'hollywood-undead', 'elton-john', 'Prince'];
// randomBands[3] = 'snoop-dog';
// console.log(randomBands)

// //for loops
// var iceCream = ['pistachio', 'lavender', 'mangosteen', 'coconut', 'mint chip', 'brownnie fudge triple bypass']
...
// for(var i = 0; i < iceCream.length; i = i + 2) {
//   console.log(iceCream[i])
// }
